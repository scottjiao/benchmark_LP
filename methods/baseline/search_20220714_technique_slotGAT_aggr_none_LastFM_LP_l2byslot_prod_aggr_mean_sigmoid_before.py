...
prefix="technique_newCsv";specified_args=["dataset",   "net",      "slot_aggregator","inProcessEmb","l2BySlot","prod_aggr","sigmoid"]


fixed_info={"task_property":prefix,"net":"slotGAT","slot_aggregator":"None","inProcessEmb":"True","l2BySlot":"True","prod_aggr":"mean","sigmoid":"before"}
