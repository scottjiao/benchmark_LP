...
fixed_info={"task_property":prefix,"net":"slotGAT","slot_aggregator":"HAN","inProcessEmb":"True",}
task_space={"hidden-dim":"[64,128]","num-layers":"[3,4]","lr":"[5e-4,1e-3,5e-3]","weight-decay":"[5e-4,1e-3,5e-3]","feats-type":[3],"num-heads":[2,4],"epoch":[300],"decoder":["dot"],"batch-size":[8192],"HANattDim":[8,32,64,128]}
