...
prefix="technique_newCsv";specified_args=["dataset",   "net",      "slot_aggregator","sigmoid","logitsRescale","prod_aggr"]


fixed_info={"task_property":prefix,"net":"slotGAT","slot_aggregator":"None","inProcessEmb":"True","l2BySlot":"True","prod_aggr":"sum","sigmoid":"None","logitsRescale":"slotNum"}
