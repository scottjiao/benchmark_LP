...
task_space={"hidden-dim":"[64,128]","num-layers":"[3,4]","lr":"[1e-3,5e-3,1e-2]","weight-decay":"[5e-4,1e-3,5e-3]","feats-type":[3],"num-heads":[2,4],"epoch":[300],"decoder":["dot"],"batch-size":[8192]}
