...
resources_dict={"0":2,"1":2}   #id:load
...
prefix="technique_newCsv";specified_args=["dataset",   "net",      "slot_aggregator","HANattDim"]


fixed_info={"task_property":prefix,"net":"slotGAT","slot_aggregator":"HAN","inProcessEmb":"False",}
task_space={"hidden-dim":"[64,128]","num-layers":"[3,4]","lr":"[5e-4,1e-3,5e-3]","weight-decay":"[5e-4,1e-3,5e-3]","feats-type":[3],"num-heads":[2,4],"epoch":[300],"decoder":["dot"],"batch-size":[8192],"HANattDim":[32]}
