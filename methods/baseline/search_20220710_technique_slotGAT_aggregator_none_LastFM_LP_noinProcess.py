...
prefix="technique_newCsv";specified_args=["dataset",   "net",      "slot_aggregator","inProcessEmb"]


fixed_info={"task_property":prefix,"net":"slotGAT","slot_aggregator":"None","inProcessEmb":"False"}
